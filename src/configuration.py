...
DEFAULT_CONFIG: dict[str, Any] = {
    ...
    "bot": {
        ...
        "notification_close_selectors": [
            ...
            ".introjs-tooltipbuttons button:has-text('Terminar')",
            ".introjs-tooltipbuttons a:has-text('Terminar')",
...
def build_bot_settings(config: dict[str, Any]) -> BotSettings:
    ...
    return BotSettings(
        ...
        post_login_url=_coerce_optional_string(bot.get("post_login_url", ""), default=""),
        post_login_open_new_tab=_coerce_bool(
            bot.get("post_login_open_new_tab", defaults["post_login_open_new_tab"]),
            "bot.post_login_open_new_tab",
        ),
        close_notifications_after_login=_coerce_bool(
